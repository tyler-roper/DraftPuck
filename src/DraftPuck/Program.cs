...
using DraftPuck.Middleware;
using DraftPuck.Services;
...
builder.Services.AddHttpClient<INhlApiService, NhlApiService>(client => client.BaseAddress = new Uri("https://statsapi.web.nhl.com/api/v1/"));
builder.Services

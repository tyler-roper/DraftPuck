...
export default class FeedItem {
    constructor(gamePk, type, subType, time, title, text, subtext, teamColor, images, player) {
        this.gamePk = gamePk;
        this.type = type;
    ...
    static fromPlay(gamePk, lineScoreTeams, play) {
    ...
    static fromLobbyEvent(lobbyEvent) {
    ...
    static getRandomGoalText(playerName, scoringPlay) {

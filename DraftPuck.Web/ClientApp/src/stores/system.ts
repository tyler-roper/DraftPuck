...
export const useSystemStore = defineStore('system', () => {
    ...
    async function initAppSettings() {
        ...
        setAppSettings({ appIsTestMode: result.isTestMode, appStartupTime: result.startupTimeUtc, appTestModeStartTime: result.testModeStartDateTimeUtc, gitSha: result.gitSha })
    }
    //#endregion

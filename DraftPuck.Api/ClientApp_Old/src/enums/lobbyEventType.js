...
(function (LobbyEventType) {
    ...
    LobbyEventType[LobbyEventType["GoalRemoved"] = 9] = "GoalRemoved";
    LobbyEventType[LobbyEventType["UserRejoined"] = 10] = "UserRejoined";
    LobbyEventType[LobbyEventType["UserRemoved"] = 11] = "UserRemoved";
    LobbyEventType[LobbyEventType["Broadcast"] = 12] = "Broadcast";

...
{
    private static readonly ConcurrentDictionary<string, LobbyMemberEntity> CurrentConnections = [];

    public async Task JoinLobby(string lobbyCode, LobbyMemberEntity member)
    {
